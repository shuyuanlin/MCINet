...
# data
_C.data = edict()
_C.data.dataset_root = '/data/PARENet1/data/KITTI'
...
_C.fine_matching.inlier_threshold = 1.2
_C.fine_matching.confidence_threshold = 0.005
_C.fine_matching.num_hypotheses = 2500
...
_C.fine_loss.negative_radius = 1.2
